...
| DEBT-E1-PR1-002 | Discover/provider Containment | Blocker | Inherited implementation blocker | Discover and metadata provider endpoints are unstable provider APIs requiring account-token query parameters pending live Plex fixture evidence; PR 8 contains them behind `PlexWatchlistAPI` / `PlexWatchlistProviderBoundary`, documents retained query-token rationale, redacts diagnostics, and test-covers graceful provider failure | `E1-PR1-SCAN-007`, `E1-PR5-CONTAIN-001`, `E1-PR5-SCAN-001`, `E1-PR8-CONTAIN-001`, `E1-PR8-TEST-001`, `E1-PR8-TEST-002`, and `E1-PR8-SCAN-001` | Epic 1 owner | 1, 3, 5 | Resolved for Epic 1 containment; query-token/live-evidence debt remains under DEBT-E1-PR1-001 and DEBT-E1-PR1-004 | 2026-06-07 | Discover/watchlist adapter owns these endpoints, redacts diagnostics, and documents graceful degradation |
...
| DEBT-E1-PR1-004 | Live Plex Fixture Coverage | Major | Accepted debt | No approved live Plex fixture command or credentialed fixture environment exists for PR 1 evidence capture; PR 6 adds unit coverage for Home identity/profile switching, PR 7 adds unit coverage for multi-server selection/connection ordering, and PR 8 adds Discover/provider containment unit coverage, but live PMS/Home/multi-server/provider validation remains unavailable | `E1-PR1-MISS-001`, `E1-PR6-TEST-001`, `E1-PR7-TEST-001`, `E1-PR8-TEST-001`, and `E1-PR8-TEST-002` | Epic 1 owner | 1, 5 | Open | 2026-06-14 | Epic 1 closure includes live UAT evidence or an accepted fixture strategy with Project Owner approval |
