...
/// reusable, and extensible for future styles. The poster→landscape-on-focus
/// case was intentionally dropped (product decision); Recently Added is a
/// landscape shelf (`.landscape`), and standard rows stay `.poster`.
